...
import Ss from "../app/user/otp/page";
const page = () => {
  return (
    <>
      <Ss/>
...
//           />
//         </div>
//         <div className="flex  flex-col gap-10 items-center justify-center md:hidden">
//           <Image
//             src={Logo}
//             width={44}
//             height={44}
...
//           </h5>
//         </div>
//         <p className="text-[15px]  text-gray-700 leading-[20px] font-medium ">
