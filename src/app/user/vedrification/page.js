...
const page = () => {
  return (
    <div className="md:bg-[#F6F5F7] bg-white pt-7 pb-7 md:pb-14 md:pt-14  h-screen md:h-auto gap-12 flex-col justify-between  md:justify-center flex md:items-center overflow-x-hidden ">
      <div className="md:w-[520px] w-full text-center  md:h-auto px-4 py-8  md:px-10 md:py-10 gap-10 md:gap-8 flex flex-col items-center  md:rounded-[18px] bg-white md:border-[0.5px] md:border-gray-300">
        ...
        {/* <Image
          ...
          alt="Loginlogo"
        /> */}
        <div className=" border p-4 md:p-5 mt-10 md:mt-7 rounded-full text-[60px] md:text-[75px] text-gray-400">
          <SlClock />
        </div>
        ...
        <p className="md:text-[15px] text-[13px] text-gray-700 leading-[20px] mx-auto font-medium max-w-[350px]">
          We well notify you when your account is verified. which which can take
