...
const OfficialPage = () => {
  ...
  return (
    <div className="bg-[#F6F5F7] w-full py-6 sm:py-8 gap-6 flex-col min-h-screen justify-center flex items-center overflow-hidden">
      <div className="w-[90%] sm:w-[520px] max-w-md sm:max-w-lg md:max-w-xl lg:max-w-2xl text-center px-6 sm:px-10 py-6 sm:py-10 gap-4 flex flex-col items-center  rounded-[18px] bg-white border-[0.5px] border-gray-300 ">
        ...
        <p className="text-[11px] sm:text-[15px] text-gray-500 leading-[20px] font-medium text-center ">
          ...
          <div className="w-full max-w-sm">
            {[
              ...
              <div key={item.name} className="flex items-center gap-2 mb-4">
                ...
                />
                <a href={item.link} className="underline text-[13px] sm:text-[18px]  text-gray-400 leading-[20px] font-medium text-center">
                  {item.label}
                </a>
              </div>
            ))}
        ...
        <div className="w-full mb-10 sm:mb-6">
